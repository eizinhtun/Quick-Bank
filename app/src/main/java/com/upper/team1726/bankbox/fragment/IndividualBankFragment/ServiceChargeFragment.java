...
public class ServiceChargeFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_service_charge, container, false);
        ...
        linearLayout = (LinearLayout) view.findViewById(R.id.serviceLayout);
        ...
        try {
            ...
            for (int i = 0; i < arrJSON.length(); i++) {
                ...
                if (bankName.equals(objJSON.getString("Bank"))) {
                    ...
                    tvCard.setText(objJSON.getString("Service"));
...
//                    tvAccount.setCompoundDrawablesWithIntrinsicBounds(0, 0, R.drawable.downarrow, 0);
    ...
    private String loadJSONFromAsset() {
        ...
        try {
            InputStream is = getActivity().getAssets().open("BankServiceCharge.json");
